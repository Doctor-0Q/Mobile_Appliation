    ...
    <View className='gap-y-4'>
      <TouchableOpacity onPress={() => toggleSection("myPractice")}>
        <View className="flex flex-row  h-auto py-4 px-4 bg-[#FFFFFF]">
          ...
          <View className="mx-6 ml-9">
            ...
            <Text className="text-gray-600">Practice profile and details</Text>
          </View>
      ...
      <TouchableOpacity onPress={() => toggleSection("locationRooms")}>
        <View className="flex flex-row  h-auto py-4 px-4 bg-[#FFFFFF]">
          ...
          <View className="mx-6">
            <Text className="text-xl font-bold mb-3">Location and Rooms</Text>
      ...
      <TouchableOpacity onPress={() => toggleSection("payment")}>
        <View className="flex flex-row  h-auto py-4 px-4 bg-[#FFFFFF]">
          ...
          <View className="mx-6">
            ...
            <Text className="text-gray-600">Account and payment details</Text>
          </View>
          <Image source={right} className="absolute right-7 top-[50%]" />
        </View>
      </TouchableOpacity>
      {openSection === "payment" && (
        <View style={{ padding: 10 }} className='mx-auto gap-y-1'>
          ...
          <Text className='text-[17px] font-bold text-center'>No payment details found</Text>
          <Text className='text-sm font-bold text-gray-500 text-center'>setup your bank account for patients to pay </Text>
          <Text className='text-sm font-bold text-gray-500 text-center'>their services </Text>
          <Text className=' text-white px-3 py-2 rounded-[4px] font-bold  bg-[#0000AC] mx-auto'>Add</Text>
        </View>
      ...
      <TouchableOpacity onPress={() => toggleSection("users")}>
        <View className="flex flex-row  h-auto py-4 px-4 bg-[#FFFFFF]">
          ...
          <View className="mx-6">
            ...
            <Text className="text-gray-600">Management and Registration for Users</Text>
          </View>
          <Image source={right} className="absolute right-7 top-[50%]" />
        </View>
      </TouchableOpacity>
      ...
      <TouchableOpacity onPress={() => toggleSection("accessPermission")}>
        <View className="flex flex-row  h-auto py-4 px-4 bg-[#FFFFFF]">
          ...
          <View className="mx-6">
            <Text className="text-xl font-bold mb-3">Access Permission</Text>
            <Text className="text-gray-600">Access rights configuration</Text>
          </View>
          <Image source={right} className="absolute right-7 top-[50%]" />
        </View>
      </TouchableOpacity>
