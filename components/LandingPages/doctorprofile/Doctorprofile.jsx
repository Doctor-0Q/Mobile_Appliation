            ...
            <Animated.View style={[headerAnimatedStyle]}>
              <View className="items-center justify-center py-2">
                <View className="h-20 w-20 rounded-full overflow-hidden">
                  <Image source={doctorprofile} resizeMode="cover" className="h-full w-full" />
                </View>
          ...
          {!showHeader && (
            <>
              ...
              <View className="flex-row items-center justify-between">
                <Text className="text-3xl font-bold text-center">DR. Kim Derek</Text>
                <TouchableOpacity className="ml-3">
                  <Feather name="bookmark" size={24} color="#000" />
                </TouchableOpacity>
              </View>
              <Text className="text-lg text-[#777777] mb-3 mx-1">ENT Surgeon</Text>
              <Text className="text-sm text-left mb-5 px-2">
                Dr. Kim Derek, is a distinguished ENT surgeon renowned for her expertise in diagnosing and treating conditions affecting the ear, nose, and throat. With a passion for improving patients' quality of life, Dr. Chen combines compassion with cutting-edge medical knowledge to provide comprehensive care.
              </Text>
              ...
              <View className="flex-row items-center">
                ...
                <Text className="text-[#7B7B7B] ml-2">04:00 PM - 08:00 PM</Text>
              </View>
            </>
          )}
          <View>
